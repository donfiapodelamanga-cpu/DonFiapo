...
impl BurnManager {
    ...
    /// Auxiliar para verificar se o hash já existe (simplificado)
    fn convert_hash_to_bytes_check(&self, _hash: &str) -> bool {
        // Nota: A verificação real é mantida na memória do BurnManager
        // através de processed_transactions da SolanaIntegration
        // Esta função é um placeholder para consultas de verificação
        false
    }

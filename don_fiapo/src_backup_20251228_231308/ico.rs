...
impl ICOManager {
    ...
    fn initialize_ipfs_configs(&mut self) {
        self.ipfs_configs = vec![
            ...
            IPFSConfig {
                image_hash: String::from("QmShovelCommoner01Hash"), // Hash IPFS real da imagem
                metadata_hash: String::from("QmMetadataFreeHash"), // Hash IPFS real dos metadados
                gateway_url: self.default_ipfs_gateway.clone(),
            },
            // NFT Tier 2 - The Pickaxe of the Royal Guard
            IPFSConfig {
                image_hash: String::from("QmPickaxeRoyalHash"), // Hash IPFS real da imagem
                metadata_hash: String::from("QmMetadataTier2Hash"), // Hash IPFS real dos metadados
                gateway_url: self.default_ipfs_gateway.clone(),
            },
            // NFT Tier 3 - The Candelabrum of the Explorer
            IPFSConfig {
                image_hash: String::from("QmCandelabrumExplorerHash"), // Hash IPFS real da imagem
                metadata_hash: String::from("QmMetadataTier3Hash"), // Hash IPFS real dos metadados
                gateway_url: self.default_ipfs_gateway.clone(),
            },
            // NFT Tier 4 - The Power to Unlock the Kingdom's Wealth
            IPFSConfig {
                image_hash: String::from("QmPowerUnlockHash"), // Hash IPFS real da imagem
                metadata_hash: String::from("QmMetadataTier4Hash"), // Hash IPFS real dos metadados
                gateway_url: self.default_ipfs_gateway.clone(),
            },
            // NFT Tier 5 - The Royal Treasure Map
            IPFSConfig {
                image_hash: String::from("QmTreasureMapHash"), // Hash IPFS real da imagem
                metadata_hash: String::from("QmMetadataTier5Hash"), // Hash IPFS real dos metadados
                gateway_url: self.default_ipfs_gateway.clone(),
            },
            // NFT Tier 6 - The Golden Mango Eye
            IPFSConfig {
                image_hash: String::from("QmGoldenMangoEyeHash"), // Hash IPFS real da imagem
                metadata_hash: String::from("QmMetadataTier6Hash"), // Hash IPFS real dos metadados
                gateway_url: self.default_ipfs_gateway.clone(),
            },
            // NFT Tier 7 - The Royal Scepter of Don Himself
            IPFSConfig {
                image_hash: String::from("QmRoyalScepterHash"), // Hash IPFS real da imagem
                metadata_hash: String::from("QmMetadataTier7Hash"), // Hash IPFS real dos metadados
                gateway_url: self.default_ipfs_gateway.clone(),
            },
        ];
    }

...
import { SYSTEM_WALLET_SYMBOLS, SYSTEM_WALLET_TEMPLATES } from "@/lib/system-wallets";
...
const WALLET_TEMPLATES = [...SYSTEM_WALLET_TEMPLATES];
const SYMBOL_OPTIONS = [...SYSTEM_WALLET_SYMBOLS];

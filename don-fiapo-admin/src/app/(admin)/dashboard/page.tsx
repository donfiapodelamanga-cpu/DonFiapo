    ...
    const fetchAllData = async () => {
        try {
            ...
            if (salesRes.ok) {
                ...
                setSales(Array.isArray(salesData) ? (salesData as SaleRow[]) : []);
            } else {
            ...
            if (transRes.ok) {
                ...
                setTransactions(Array.isArray(transData) ? (transData as TransactionRow[]) : []);
            } else {
            ...
            if (campRes.ok) {
                ...
                setCampaigns(Array.isArray(campData) ? (campData as CampaignRow[]) : []);
            } else {
            ...
            if (partnersRes.ok) {
                ...
                setPartners(Array.isArray(partnersData) ? (partnersData as PartnerRow[]) : []);
            } else {
        ...
        <div className="p-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <StatCard
                    ...
                    change={`${partners.filter((p) => p.status === 'active').length} ativos`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <StatCard
                    ...
                    change={`${transactions.filter((t) => t.status === 'completed').length} concluídas`}

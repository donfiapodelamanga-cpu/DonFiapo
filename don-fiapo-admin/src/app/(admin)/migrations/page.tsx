...
import {
  Ship, Loader2, Clock, ExternalLink
} from "lucide-react";
...
const MIGRATION_TABS: Array<"PENDING" | "APPROVED" | "REJECTED"> = ["PENDING", "APPROVED", "REJECTED"];
...
export default function MigrationsPage() {
  ...
  useEffect(() => {
    ...
    // session state is not used in this component currently
    // setSession(s);
    fetchMigrations(tab);

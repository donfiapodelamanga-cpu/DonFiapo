          ...
          <div className="bg-neutral-900/40 border border-neutral-800/50 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-neutral-400 text-xs leading-relaxed">
                  Receita dividida: <strong className="text-white">{config?.commissionSplit.noble || "58.3%"}</strong> para Noble, <strong className="text-white">{config?.commissionSplit.commercial || "41.7%"}</strong> para Comercial. Pagamento a cada {config?.payoutInterval || "15 dias"}.
                </p>
              </div>
            </div>
          </div>

...
type CollectionItemWhereInput = NonNullable<Parameters<typeof prisma.nFTCollectionItem.findMany>[0]>["where"];
type CollectionItemUpdateData = Parameters<typeof prisma.nFTCollectionItem.update>[0]["data"];
...
export async function GET(
  ...
  try {
    ...
    const where: CollectionItemWhereInput = { collectionId: id };
...
export async function PATCH(
  ...
  try {
    ...
    const data: CollectionItemUpdateData = {};

...
import { buildSystemWalletSeedRows } from "../src/lib/system-wallets";
...
async function main() {
    ...
    // 8. Create System Wallet templates.
    // Existing rows keep their configured address/status; new rows are inactive until an address is provided.
    for (const wallet of buildSystemWalletSeedRows(process.env)) {
